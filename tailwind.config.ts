  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "scale-in": { "0%": { transform: "scale(1.08)", opacity: "0" }, "100%": { transform: "scale(1)", opacity: "1" } },
      },
      animation: {
        "accordion-down": "accordion-down 0.2s ease-out",
        "accordion-up": "accordion-up 0.2s ease-out",
        "fade-in": "fade-in 0.9s cubic-bezier(0.65,0,0.35,1) both",
        "fade-in-slow": "fade-in-slow 1.6s ease-out both",
        "slide-up": "slide-up 0.9s cubic-bezier(0.65,0,0.35,1) both",
        "scale-in": "scale-in 1.4s cubic-bezier(0.65,0,0.35,1) both",
      },
    },
  },
